...
| W1-T01 | READY | W11-T01 | Scheduled | Pending bounded worker | Pending interface/security reviewer | COTIK HTTP client/error contract only | Client unit tests, redaction/security tests | — | — | — | None | No writes; COTIK token remains server-side and local guide remains ignored. |
