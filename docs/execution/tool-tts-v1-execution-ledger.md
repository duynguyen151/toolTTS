...
| W11-T02 | READY | W11-T01 | Scheduled | Pending bounded DB worker | Pending PostgreSQL reviewer | Schema, migration, provider bindings | Migration/repository tests; Drizzle check | — | — | — | ENVIRONMENT_PENDING: disposable PostgreSQL | Exclusive schema/migration writer. |
