...
- `pnpm shop-health doctor --json`: EXIT 1; AdsPower FAIL (`fetch failed`), PostgreSQL connection OK, Node OK. Supabase-backed status and idempotent migration checks passed; both switches remain OFF.
