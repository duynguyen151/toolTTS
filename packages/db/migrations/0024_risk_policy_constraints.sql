ALTER TABLE "risk_policy_revisions" DROP CONSTRAINT "risk_policy_revisions_payload_object";--> statement-breakpoint
ALTER TABLE "risk_policy_revisions" ADD CONSTRAINT "risk_policy_revisions_effective_from_finite" CHECK ("risk_policy_revisions"."effective_from" not in ('infinity'::timestamptz, '-infinity'::timestamptz));--> statement-breakpoint
