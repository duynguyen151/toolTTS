CREATE TABLE "ai_task_configs" (
	...
	CONSTRAINT "ai_task_configs_base_url_valid" CHECK ("base_url" ~ '^https?://([A-Za-z0-9.-]+|\[[0-9A-Fa-f:.]+\])(:([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5]))?(/[^?#[:space:]]*)?$'),
