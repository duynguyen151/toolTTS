    ...
    check("refresh_checkpoint_attempts_proxy_preflight_valid", sql`${table.proxyPreflight} is null or (
      ...
      and (jsonb_typeof(${table.proxyPreflight}->'exitIp') = 'null' or (
        (${table.proxyPreflight}->>'exitIp') ~ '^(?:(?:25[0-5]|2[0-4][0-9]|1?[0-9]?[0-9])\\.){3}(?:25[0-5]|2[0-4][0-9]|1?[0-9]?[0-9])$'
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 0 and 16777215
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 167772160 and 184549375
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 1681915904 and 1686110207
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 2130706432 and 2147483647
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 2851995648 and 2852061183
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 2886729728 and 2887778303
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3221225472 and 3221225727
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3221225984 and 3221226239
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3223307264 and 3223307519
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3224682752 and 3224683007
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3227017984 and 3227018239
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3232235520 and 3232301055
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3232706560 and 3232706815
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3323068416 and 3323199487
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3325256704 and 3325256959
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3405803776 and 3405804031
         and ((split_part(${table.proxyPreflight}->>'exitIp', '.', 1)::bigint * 16777216) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 2)::bigint * 65536) + (split_part(${table.proxyPreflight}->>'exitIp', '.', 3)::bigint * 256) + split_part(${table.proxyPreflight}->>'exitIp', '.', 4)::bigint) not between 3758096384 and 4294967295
      ))
      and (
